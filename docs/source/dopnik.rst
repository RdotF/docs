...
Проверка груза выполняется после подтверждения наличия **ИНН** и **допника у брокера** (номер договора).


Просмотр зарегистрированного груза
----------------------------------

Для просмотра зарегистрированного груза в **Альта-СВХ** необходимо перейти:

::

   Транспорт → Партии товара


В фильтре заполнить поле:

::

   Брокер → номер договора


Если номер договора брокера найден, можно просмотреть зарегистрированные партии товара.


.. image:: images/gruz-1.png
   :alt: Просмотр партий товара в Альта-СВХ
   :align: center
   :width: 700px


Если номер брокера не найден, значит груз еще не зарегистрирован.

В таком случае проведение верификации невозможно. Необходимо дождаться регистрации груза в системе.


Проверка прибытия транспортного средства
-----------------------------------------

Чтобы проверить, прибыла ли машина на территорию СВХ, необходимо перейти:

::

   Транспорт → Журнал въезда и выезда транспортных средств


Для удобства поиска можно установить фильтры:

* **На территории СВХ**
* **Незарегистрированный**


.. image:: images/gruz-2.png
   :alt: Журнал въезда и выезда транспортных средств
   :align: center
   :width: 700px
...
* по получателю;
* либо по номеру транспортного средства.


Результаты проверки:

* если записи отсутствуют — транспортное средство не прибыло на территорию СВХ;
* если запись существует — машина прибыла, но груз еще не прошел регистрацию.


.. note::
   Проверка груза производится только после подтверждения наличия ИНН и допника у брокера (номер договора).
